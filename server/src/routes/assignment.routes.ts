...
router.route('/getAllAssignments').get(verifyJWT, verifyNoCustomContestCookie, assignmentController.getAllAssignments);
router.route('/create').post(verifyJWT, verifyIsAdmin, assignmentController.createAssignment);
router.route('/:assignmentId').get(verifyJWT, verifyNoCustomContestCookie, assignmentController.getAssignment);
...
router.route('/getAssignmentDeadline/:assignmentId').get(verifyJWT, verifyNoCustomContestCookie, assignmentController.getAssignmentDeadline);
