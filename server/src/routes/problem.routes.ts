...
// Create the routes
router.route('/all').get(verifyJWT, verifyNoCustomContestCookie, problemController.getAllProblems);
router.route('/:problemId').get(verifyJWT, verifyNoCustomContestCookie, problemController.getProblemById);
router.route('/getProblemByIds').post(verifyJWT, verifyNoCustomContestCookie, problemController.getProblemsByIds);
